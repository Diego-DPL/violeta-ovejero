...
function Prices({servicios}) {
    ...
    return (
        <div className='pricesContainer bg-bg1 w-full h-[80vh] flex flex-col items-center justify-center overflow-hidden'>
            <h1 className='pricesTitle font-bold w-full text-4xl text-brand2 mb-8 '>Nuestras Tarifas</h1> 
            <p className='pricesDescription w-3/4 text-xl text-brand2 mb-4'>Conoce nuestras tarifas y elige el servicio que mejor se adapte a tus necesidades. Ofrecemos opciones accesibles y flexibles para brindarte el apoyo psicológico que mereces.</p>
            <div className='servicioslist flex flex-row gap-10 items-center justify-center'>
                {servicios.map((servicio, index) => (
                    <div  key={index} className='servicioCard bg-bg1 border border-bg2 hover:border-2 rounded-lg p-[0px_40px_20px_40px] text-brand2 w-1/4 max-h-custom overflow-hidden'>
